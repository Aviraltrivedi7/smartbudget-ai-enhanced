...
router.post('/register', [
  ...
  try {
    ...
    // Update user activity and add welcome points
    await user.updateActivity();
    await user.addPoints(100, 'Welcome bonus');
...
router.post('/login', [
  ...
  try {
    ...
    // Update activity and add login points
    await user.updateActivity();
...
router.put('/profile', authenticateToken, [
  ...
  try {
    ...
    const allowedUpdates = ['fullName', 'phoneNumber', 'dateOfBirth', 'avatar'];
