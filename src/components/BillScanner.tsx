...
const BillScanner: React.FC<BillScannerProps> = ({ onBack, onSave }) => {
  ...
  const simulateOCR = (imageData: string) => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Bill Scan Ho Gaya! 📷",
        description: "OCR se maine saari details nikal li hain.",
      });
    }, 2000);
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-medium">Buss photo kheencho aur bill auto-fill ho jayega!</p>
          </div>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                {isScanning && (
                  <div className="text-center p-4">
                    ...
                    <p>Bill scan ho raha hai bhai, thoda ruko...</p>
                    <div className="mt-2">
