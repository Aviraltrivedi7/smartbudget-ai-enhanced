...
const MoneyMonster: React.FC<MoneyMonsterProps> = ({ onBack, transactions }) => {
  ...
  const getMonsterMessage = () => {
    switch (monsterMood) {
      case 'happy': return 'Gazab! Budget ke andar hi ho. Party toh banti hai! 🥳';
      case 'worried': return 'Dekh ke bhai... thoda zyada uuda rahe ho 🤔';
      case 'angry': return 'WARNING: Bhai, dhyan se! Kharcha control karo warna problem hogi 😠';
      case 'danger': return 'DANGER ZONE! Abhi ke abhi kharcha band karo bhai! 🚨';
      default: return 'Kharcha track karte raho, safe rahoge!';
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-medium tracking-tight">Aapke kharche ka emotional partner!</p>
          </div>
        </div>
        ...
        <Card className="border-0 card-shadow">
          <CardHeader>
            <CardTitle>📊 Budget Kitna Kharch Hua?</CardTitle>
          </CardHeader>
