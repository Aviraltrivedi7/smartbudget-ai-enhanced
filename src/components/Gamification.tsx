...
const Gamification: React.FC<GamificationProps> = ({ onBack, transactions }) => {
  ...
  const [badges, setBadges] = useState<Badge[]>([
    { id: '1', name: 'First Saver 🏆', description: 'Pehli baar thode paise bachaye!', icon: '🏆', earned: false, progress: 0, target: 500 },
    { id: '2', name: 'Budget Master 💰', description: '10 transactions record karo!', icon: '💰', earned: false, progress: 0, target: 10 },
    { id: '3', name: 'Expense Tracker 📊', description: 'Regular track karte raho!', icon: '📊', earned: false, progress: 0, target: 30 },
    { id: '4', name: 'Smart Spender 🧠', description: 'Budget limit ke andar raho!', icon: '🧠', earned: false, progress: 0, target: 1 },
    { id: '5', name: 'Saving Champion 🏅', description: 'Mast savings maintain karo!', icon: '🏅', earned: false, progress: 0, target: 5000 },
  ]);
  ...
  const challenges = [
    { title: "Aaj thoda bachao! 💰", reward: "50 points", completed: false },
    { title: "5 transactions add karo! ✅", reward: "100 points", completed: transactions.length >= 5 },
    { title: "Food category pe control rakho! 🍽️", reward: "75 points", completed: false },
  ];
