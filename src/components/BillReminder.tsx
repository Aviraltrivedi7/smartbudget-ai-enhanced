      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-medium">Koi bhi bill miss nahi hoga ab! Smart notifications ke saath.</p>
          </div>
        </div>
          ...
          <Card className="border-0 card-shadow bg-gradient-to-r from-orange-50 to-red-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-orange-700">
                ...
                {upcomingBills.length} Bill{upcomingBills.length > 1 ? 's' : ''} Due Hain Is Hafte! ⚠️
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="border-0 card-shadow">
          <CardContent className="p-6">
            <Button
              ...
              className="w-full financial-gradient text-white border-0 py-4 text-lg font-bold hover:opacity-90 transition-all hover:scale-105 shadow-lg"
            >
              <Plus className="mr-2 h-6 w-6" />
              Naya Bill Reminder Add Karo ➕
            </Button>
          </CardContent>
        </Card>
