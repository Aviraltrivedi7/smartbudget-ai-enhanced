  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "h-10 min-w-[124px] appearance-auto rounded-xl border border-[#dfe4ef] bg-white px-3 text-sm font-semibold text-slate-800 outline-none transition focus:border-[#5867bb] focus:ring-2 focus:ring-[#aeb8ed]/40",
