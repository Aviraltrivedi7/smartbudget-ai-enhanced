  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_month: "px-3 py-2 rounded-md bg-white dark:bg-gray-800 dark:text-white border border-gray-300 dark:border-gray-600",
        dropdown_year: "px-3 py-2 rounded-md bg-white dark:bg-gray-800 dark:text-white border border-gray-300 dark:border-gray-600",
